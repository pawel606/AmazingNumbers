...
public class Main {
    ...
    //check input and choose correct reference
    ...
    //print info about multiple elements
    ...
    static boolean goodProperties (String[] property) {
        String[] tmpProperty = new String[property.length]; //creating temporary array to eliminate "-" on each element
        ...
        //different outputs depending on 'badProperties'
        if(badProperties == 1) {
    ...
    //input property and number, checking if property is good for number and return boolean
    ...
    //properties that cannot be searched together
                            ...
                            if(exclusiveProperties(properties)) {
                                ...
                                while(matchNumbers != amountLookingNumbers) {
                                    ...
                                    for(String str : properties) {
                                        if(str.charAt(0) == '-') { //if minus property is 1, number will be skipped
